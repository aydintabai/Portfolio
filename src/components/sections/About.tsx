                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-lg leading-relaxed text-gray-700 dark:text-neutral-300">
                                Most recently, I've been a founding software engineer at HowDoIFill and an AI/ML engineer at Soaper, developing full-stack and AI driven features in end-to-end systems. I'm passionate about using technology
